export default function Header() {
  return (
    <div className="mt-8 container mx-auto w-5/6 sm:w-2/3 h-full ">
      <div className="w-full bg-white dark:bg-gray-800 py-5 flex flex-col xl:flex-row items-start xl:items-center justify-between px-5 xl:px-10 shadow rounded-2xl">
